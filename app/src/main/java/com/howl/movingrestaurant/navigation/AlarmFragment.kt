...
import kotlinx.android.synthetic.main.item_userlist.view.follow_button
...
class AlarmFragment : Fragment() {
                ...
                .addSnapshotListener { querySnapshot, firebaseFirestoreException ->
                    ...
                    for(snapshot in querySnapshot!!.documents!!){
                        if(snapshot.toObject(userDTO::class.java)!!.name.toString() == view.search.text.toString()) {
                            ...
                            view.search_result.text = searchResult.userID.toString() + " "+ searchResult.local.toString()
        ...
        init {
            ...
            FirebaseFirestore.getInstance().collection("alarms").whereEqualTo("destinationUid", uid)
                .addSnapshotListener { querySnapshot, firebaseFirestoreException ->
                    ...
                    for (snapshot in querySnapshot.documents) {
                        if(snapshot.toObject(AlarmDTO::class.java)!!.kind == 2) {
    ...
    inner class userecyclerviewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        override fun onBindViewHolder(p0: RecyclerView.ViewHolder, p1: Int) {
            ...
            view.commentviewitem_textview_profile.text = str_0
            view.follow_button.setOnClickListener {
