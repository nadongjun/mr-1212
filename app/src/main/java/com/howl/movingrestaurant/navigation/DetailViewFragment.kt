                    ...
                    if(snapshot.id == FirebaseAuth.getInstance().currentUser?.uid) {
                        ...
                        currentDTO = snapshot.toObject(FollowDTO::class.java)!!
                         Toast.makeText(
                            ...
                            "find " + currentDTO.followerCount + " find " + currentDTO.followingCount ,
                            Toast.LENGTH_LONG
                        ).show()
    ...
    inner class DetailViewRecyclerViewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
        ...
        init {
            firestore?.collection("images")?.orderBy("timestamp")?.addSnapshotListener { querySnapshot, firebaseFirestoreException ->
                ...
                for(snapshot in querySnapshot!!.documents){
                    if(snapshot.toObject(ContentDTO::class.java)!!.uid == FirebaseAuth.getInstance().currentUser?.uid || currentDTO.followers.contains(snapshot.toObject(ContentDTO::class.java)!!.uid) || currentDTO.followings.contains(snapshot.toObject(ContentDTO::class.java)!!.uid)) {
